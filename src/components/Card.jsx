...
export const CardItem = () => {
    ...
    return (
                            ...
                            <div className='list-card' key={e.id} >
                                <Card className='list-item' >
                                    <Card.Body>
                                        ...
                                        <Link to={`/user/${e.id}`}><Button variant="success">View User</Button></Link>
                                    </Card.Body>
                                </Card>
                            </div>
                        )
        ...
        <Button variant="dark" disabled={currentPage===1} onClick={()=>setCurrentPage(currentPage-1)}>Prev</Button>
        <h3>{currentPage}</h3>
        <Button variant="dark" onClick={()=>setCurrentPage(currentPage+1)}>Next</Button>
        </div>
